"""lopez_de_mexico_23377 URL Configuration
...
admin.site.site_header = "Lopez de Mexico"
admin.site.site_title = "Lopez de Mexico Admin Portal"
admin.site.index_title = "Lopez de Mexico Admin"

# swagger
api_info = openapi.Info(
    title="Lopez de Mexico API",
    default_version="v1",
    description="API documentation for Lopez de Mexico App",
)
